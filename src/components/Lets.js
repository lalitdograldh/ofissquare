...
const Lets = () => {
  return (
    <>
        <div className="lets" id="lets">
          <div className="box">
              <h2>Let’s talk to coffee about you requirements.</h2>
              <p>Please take a minute to outline your requirement. Our solutions expert will be in touch shortly. Call Us On +91 95600 50321</p>
              {/* <form>
                  <ul>
                      <li>
                          <label>Name</label>
              ...
              <script type='text/javscript' src="https://campaigns.zoho.in/js/zc.iframe.js"></script>
