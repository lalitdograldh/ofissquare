...
import Rectangle46 from "../images/mgRoadRectangle46.jpg";
import Rectangle48 from "../images/mgRoadRectangle48.jpg";
import Rectangle50 from "../images/mgRoadRectangle50.jpg";
import Rectangle79 from "../images/mgRoadRectangle79.jpg";
            ...
            <div className="container">
               <div className="row align-items-center">
                  ...
                  <div className="col-md-6 amenities">
                     ...
                     <p>From gourmet coffee to spacious parking, OFIS SQUARE MG Road, offers amenities that help you and your teams operate without worries.</p>
                     <ul className="text">
                        {itemsData.map((item, index) => (
                           <li key={index}>
                              <div className="box1">
                                 <h5><span><img src={item.img} alt={index} /></span> {item.heading}</h5>
                                 <p>{item.desc}</p>
                              </div>
                           </li>
                        ))}
